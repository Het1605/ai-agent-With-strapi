...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['active', 'inactive', 'closed']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTransactionAuditLogTransactionAuditLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'transaction_audit_logs';
  info: {
    displayName: 'Transaction Audit Log';
    pluralName: 'transaction-audit-logs';
    singularName: 'transaction-audit-log';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    change_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    change_reason: Schema.Attribute.String & Schema.Attribute.Required;
    changed_by: Schema.Attribute.Relation<'manyToOne', 'api::user.user'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaction-audit-log.transaction-audit-log'
    > &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    transaction_audit_reference: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiTransactionHistoryTransactionHistory
  ...
  attributes: {
    ...
    change_reason: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    transaction_reference: Schema.Attribute.Relation<
      'manyToOne',
      'api::transaction.transaction'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTransactionMetadataTransactionMetadata
  extends Struct.CollectionTypeSchema {
  collectionName: 'transaction_metadatas';
  info: {
    displayName: 'Transaction Metadata';
    pluralName: 'transaction-metadatas';
    singularName: 'transaction-metadata';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_sensitive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaction-metadata.transaction-metadata'
    > &
      Schema.Attribute.Private;
    metadata_key: Schema.Attribute.String & Schema.Attribute.Required;
    metadata_value: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    transaction_metadata_reference: Schema.Attribute.Relation<
      'manyToOne',
      'api::transaction.transaction'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<['pending', 'completed', 'failed']> &
      Schema.Attribute.Required;
    transaction_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    transaction_type: Schema.Attribute.Enumeration<['debit', 'credit']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUserTransactionUserTransaction
  ...
  attributes: {
    ...
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['initiator', 'approver', 'viewer']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'manyToOne', 'api::user.user'>;
    user_transaction_reference: Schema.Attribute.Relation<
      'manyToOne',
      'api::transaction.transaction'
    >;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::transaction-audit-log.transaction-audit-log': ApiTransactionAuditLogTransactionAuditLog;
      'api::transaction-history.transaction-history': ApiTransactionHistoryTransactionHistory;
      'api::transaction-metadata.transaction-metadata': ApiTransactionMetadataTransactionMetadata;
