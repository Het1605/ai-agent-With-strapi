...
export interface ApiAdministrativeStaffAdministrativeStaff
  extends Struct.CollectionTypeSchema {
  collectionName: 'administrative_staffs';
  info: {
    displayName: 'Administrative Staff';
    pluralName: 'administrative-staffs';
    singularName: 'administrative-staff';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::administrative-staff.administrative-staff'
    > &
      Schema.Attribute.Private;
...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    class_schedule: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiBookIssueBookIssue extends Struct.CollectionTypeSchema {
  collectionName: 'book_issues';
  info: {
    displayName: 'Book Issue';
    pluralName: 'book-issues';
    singularName: 'book-issue';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiBookReturnBookReturn extends Struct.CollectionTypeSchema {
  collectionName: 'book_returns';
  info: {
    displayName: 'Book Return';
    pluralName: 'book-returns';
    singularName: 'book-return';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCanteenInventoryCanteenInventory
  extends Struct.CollectionTypeSchema {
  collectionName: 'canteen_inventories';
  info: {
    displayName: 'Canteen Inventory';
    pluralName: 'canteen-inventories';
    singularName: 'canteen-inventory';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::canteen-inventory.canteen-inventory'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCanteenMenuCanteenMenu extends Struct.CollectionTypeSchema {
  collectionName: 'canteen_menus';
  info: {
    displayName: 'Canteen Menu';
    pluralName: 'canteen-menus';
    singularName: 'canteen-menu';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCanteenOrderCanteenOrder
  extends Struct.CollectionTypeSchema {
  collectionName: 'canteen_orders';
  info: {
    displayName: 'Canteen Order';
    pluralName: 'canteen-orders';
    singularName: 'canteen-order';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::canteen-order.canteen-order'
    > &
      Schema.Attribute.Private;
...
export interface ApiClassScheduleClassSchedule
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    day_of_week: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    administrative_staffs: Schema.Attribute.Relation<
      'oneToMany',
      'api::administrative-staff.administrative-staff'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiExamExam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exam_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
...
export interface ApiFacultyAssignmentFacultyAssignment
  extends Struct.CollectionTypeSchema {
  collectionName: 'faculty_assignments';
  info: {
    displayName: 'Faculty Assignment';
    pluralName: 'faculty-assignments';
    singularName: 'faculty-assignment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::faculty-assignment.faculty-assignment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subject: Schema.Attribute.Relation<'manyToOne', 'api::subject.subject'>;
...
export interface ApiGradeGrade extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    grade_value: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHostelAllocationHostelAllocation
  ...
  attributes: {
    allocation_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHostelHostel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hostel_name: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hostel.hostel'
...
export interface ApiLibraryLibrary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    library_name: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::library.library'
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    menu_status: Schema.Attribute.Enumeration<['active', 'inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_item_status: Schema.Attribute.Enumeration<
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['credit_card', 'cash', 'paypal']> &
      Schema.Attribute.Required;
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    order_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Purchase_Order_status: Schema.Attribute.Enumeration<
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reservation_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    Reservation_status: Schema.Attribute.Enumeration<
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::room.room'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    room_number: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    enrollment_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    first_name: Schema.Attribute.String & Schema.Attribute.Required;
    last_name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTransportAllocationTransportAllocation
  extends Struct.CollectionTypeSchema {
  collectionName: 'transport_allocations';
  info: {
    displayName: 'Transport Allocation';
    pluralName: 'transport-allocations';
    singularName: 'transport-allocation';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::transport-allocation.transport-allocation'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::administrative-staff.administrative-staff': ApiAdministrativeStaffAdministrativeStaff;
      'api::attendance.attendance': ApiAttendanceAttendance;
      'api::book-issue.book-issue': ApiBookIssueBookIssue;
      'api::book-return.book-return': ApiBookReturnBookReturn;
      'api::book.book': ApiBookBook;
      'api::canteen-inventory.canteen-inventory': ApiCanteenInventoryCanteenInventory;
      'api::canteen-menu.canteen-menu': ApiCanteenMenuCanteenMenu;
      'api::canteen-order.canteen-order': ApiCanteenOrderCanteenOrder;
      ...
      'api::faculty-assignment.faculty-assignment': ApiFacultyAssignmentFacultyAssignment;
      ...
      'api::transport-allocation.transport-allocation': ApiTransportAllocationTransportAllocation;
